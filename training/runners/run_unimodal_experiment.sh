...
: "${MODALITY:?ERROR: set MODALITY=illumina or MODALITY=ont}"

DEVICE="${DEVICE:-cuda}"

echo "============================================================"
echo "[Job] Variant Calling unimodal training"
echo "============================================================"
...
python -u training/scripts/train/unimodal/train_unimodal.py \

#!/usr/bin/env python3
"""
Singleton-locus multimodal join builder.

This script implements the current baseline multimodal join policy:
...
Important:
- Despite building an `outer/` dataset, this is not a full candidate-preserving
  outer join.

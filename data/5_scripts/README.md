...
- BAM chr20:
    - `data/1_input_bams/HG003/HG003.GRCh38.2x250.chr20.bam`
    - `data/1_input_bams/HG003/HG003.GRCh38.2x250.chr20.bam.bai`
...
samtools view -H data/1_input_bams/HG003/HG003.GRCh38.2x250.chr20.bam | grep '^@SQ' | head
...
- `data/4_out/deepvariant/HG003/chr20/HG003.dv1.9.0.chr20.g.vcf.gz` (+ `.tbi`)
- logs: `data/4_out/deepvariant/HG003/chr20/logs/`
...
BAM="data/1_input_bams/${SAMPLE}/${SAMPLE}.GRCh38.2x250.chr20.bam"
REF="data/2_reference/GRCh38_no_alt_plus_hs38d1/GRCh38_no_alt_plus_hs38d1.chr20.fa"

OUT_DIR="data/4_out/deepvariant/${SAMPLE}/chr20"
LOG_DIR="${OUT_DIR}/logs"
mkdir -p "${LOG_DIR}"

OUT_VCF="${OUT_DIR}/${SAMPLE}.dv${DV_VERSION}.chr20.vcf.gz"
OUT_GVCF="${OUT_DIR}/${SAMPLE}.dv${DV_VERSION}.chr20.g.vcf.gz"
...
```bash
tail -n 80 -f data/4_out/deepvariant/HG003/chr20/logs/make_examples.log
```
...
- data/4_out/happy/HG003/chr20/HG003.dv1.9.0.chr20.summary.csv (principal)
...
QUERY_VCF="data/4_out/deepvariant/${SAMPLE}/chr20/${SAMPLE}.dv${DV_VERSION}.chr20.vcf.gz"

OUT_DIR="data/4_out/happy/${SAMPLE}/chr20"
OUT_PREFIX="${OUT_DIR}/${SAMPLE}.dv${DV_VERSION}.chr20"
mkdir -p "${OUT_DIR}"
...
head -n 30 data/4_out/happy/HG003/chr20/HG003.dv1.9.0.chr20.summary.csv
```

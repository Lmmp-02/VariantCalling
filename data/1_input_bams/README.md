...
Los alineamientos de HG003 están indexados públicamente aquí (BAM + BAI + MD5): https://ftp-trace.ncbi.nlm.nih.gov/ReferenceSamples/giab/data/AshkenazimTrio/HG003_NA24149_father/
...
> NOTA: Para las próximas secciones vamos a usar de ejemplo el **BAM de Illumina**, para el de **ONT** el proceso es **idéntico** pero **cambiando las URLs**. 
